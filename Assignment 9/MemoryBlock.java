...
public class MemoryBlock {
	 ...
	 * length in words
	 * 
	 * @param baseAddress the memory address of the first word in this block
	...
	/**
	 * A textual representation of this block, useful for debugging. The
	 * block's contents should appear within "(" and ")". (See the test output
	 * for examples).
	 */
	public String toString() {
		StringBuilder str = new StringBuilder("(");
		str.append(baseAddress);
		str.append(",");
		str.append(length);
		str.append(")");
		return str.toString();
