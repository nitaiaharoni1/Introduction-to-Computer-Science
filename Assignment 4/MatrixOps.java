...
/**
 * Testing code - operations on two-dimensional matrices.
 */
public class MatrixOps {
	 ...
	 * 
	 * @param N - the size of the wanted identity matrix
	...
	/**
	 * creates and returns a matrix of N rows and M columns, in which 
	 * 		every element is an integer between 0 and range, inclusive.
	 * 
	 * @param N - the given row number
	 * @param M - the given column number
	 * @param range - the range of every element between 0 and the 
	...
	/**
	 * Returns the sub matrix of the given matrix m, between the
	 * 		top left given element and the bottom right given element.
	 * assumes that i2>i1 and j2>j1
	 * 
	 * @param m - the given matrix
	 * @param i1 - the row value of the top left given element
	 * @param j1 - the column value of the top left given element
	 * @param i2 - the row value of the bottom right given element
	 * @param j2 - the column value of the bottom right given element
	 * @return a new matrix
	 */
